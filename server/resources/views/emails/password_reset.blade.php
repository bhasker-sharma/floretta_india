...
<title>Reset Your Password — Floretta</title>
<style>
...
<div class="wrap">
  ...
  <div class="body">
    <p>Hi there,</p>
    <p>We received a request to reset the password for your Floretta account (<strong>{{ $toEmail }}</strong>).</p>
    <p>Use this code to reset your password. It expires in <strong>15 minutes</strong>.</p>
    <div class="otp-box"><span>{{ $otp }}</span></div>
    <p class="note">If you did not request a password reset, please ignore this email. Your password will not be changed.</p>
  </div>
